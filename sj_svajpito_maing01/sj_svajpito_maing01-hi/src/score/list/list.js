...
const List = createVisualComponent({
  ...
  render(props) {
    ...
    //@@viewOn:private
    let scoreList = scoreDataList.data;
    ...
    return (
      ...
      >
        <DataObjectStateResolver dataObject={subAppData} height={PLACEHOLDER_HEIGHT}>
          <DataListStateResolver dataList={scoreDataList} height={PLACEHOLDER_HEIGHT}>
            <>
              <ListView scoreList={scoreList} baseUri={subApp.baseUri} />
            </>
