...
export default class Timer {
  constructor(scene) {
    this.scene = scene;
    this.time = 0;
    this.timerText = new Phaser.GameObjects.Text(this.scene, 0, 16, "00:00", { fontSize: "32px", fill: "#fff", stroke: "#000", align: "center", fixedWidth: this.scene.cameras.main.worldView.width });
