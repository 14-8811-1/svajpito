const Lsi = {
  appName: {
    cs: "Aplikace sjSvajpito",
    en: "Application sjSvajpito",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci sjSvajpito",
      en: "About application sjSvajpito",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní sjSvajpito.",
      en: "You can buy your own sjSvajpito.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci sjSvajpito.",
      en: "You don't have rights to initialize this sjSvajpito.",
    },
  },
